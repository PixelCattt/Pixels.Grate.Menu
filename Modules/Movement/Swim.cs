...
public class Swim : BarkModule
{
    ...
    {
        base.Start();
        waterVolume = Instantiate(GameObject.Find("Environment Objects/LocalObjects_Prefab/ForestToBeach/ForestToBeach_Prefab_V4/ForestToBeach_Geo/CaveWaterVolume"), VRRig.LocalRig.transform);
